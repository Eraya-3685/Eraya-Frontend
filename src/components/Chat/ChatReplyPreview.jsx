...
const ChatReplyPreview = ({ replyingTo, onClear, isAdminView }) => {
  ...
  return (
    <div className={`${isAdminView ? 'mb-4 p-4' : 'mb-3 p-3'} glass-card-light border border-white/[0.08] rounded-2xl flex items-center justify-between animate-in slide-in-from-bottom-2`}>
      <div className="flex items-center gap-3 overflow-hidden">
        ...
        <div className="overflow-hidden">
          ...
          <p className={`${isAdminView ? 'text-xs' : 'text-[10px]'} text-slate-300 truncate`}>
